...
# ================================================================== #
# Front tray 3×3 grid — calibrated with +5mm X, -5mm Y offset, 45 mm spacing
#   F4 = (794.004, -1394.760) mm   F5 = (794.004, -1349.760) mm
#        col0 (-45 mm)      col1 (0 mm)        col2 (+45 mm)
# row0  F0  749.004,-1439.760  F1  749.004,-1394.760  F2  749.004,-1349.760
# row1  F3  794.004,-1439.760  F4  794.004,-1394.760  F5  794.004,-1349.760
# row2  F6  839.004,-1439.760  F7  839.004,-1394.760  F8  839.004,-1349.760
FRONT_TRAY_HOLES = {
